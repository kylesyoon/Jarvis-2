...
class JARGradientView: UIView {
    ...
    override func drawRect(rect: CGRect) {
        ...
        let gradientRef = CGGradientCreateWithColors(colorSpaceRef,
                                                     self.colors,
                                                     self.locations)
...
class JARConnectedGradientView: JARGradientView {
    ...
    override func drawRect(rect: CGRect) {
        self.colors = [UIColor.whiteColor().CGColor,
                       UIColor.whiteColor().CGColor,
                       UIColor.jarvis_lightBlue().CGColor,
                       UIColor.jarvis_gunMetal().CGColor]
        self.locations = [0.0,
                          0.2,
                          0.4, 
                          1.0]
